...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "PoliceMenu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "PoliceMenu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}
